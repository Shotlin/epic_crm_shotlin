...
export function createInitialRevenueOpsState(): RevenueOpsState {
  ...
  return {
    ...
    retailHubStoreEdgeSyncReceipts: [],
    retailHubStoreEdgeSyncRuns: [],
    retailHubStoreEdgeSyncPolicy: undefined,
    retailHubStoreEdgeSyncCursor: undefined,
    retailUnifiedOrderIngestion: { orders: [], conflicts: [], reservationIntents: [], hubHandoffs: [], fulfilmentHandoffs: [], stockReservationExecutions: [], pickTaskExecutions: [], shipmentPackageExecutions: [], dispatchReadinessExecutions: [], carrierDispatchExecutions: [], deliveryExecutions: [], rtoReconciliationExecutions: [], returnReconciliationExecutions: [], cancellationReconciliationExecutions: [], carrierCallbackEvidence: [], reconciliationRequirements: [] },
...
export function getRevenueOpsSnapshot(state: RevenueOpsState, context: RevenueOpsContext, generatedAt = new Date().toISOString()): RevenueOpsSnapshot {
  ...
  return {
    ...
    retailDeliveryMapSignals: structuredClone(state.retailDeliveryMapSignals ?? []),
    ...
    retailHubStoreEdgeSyncReceipts: structuredClone(state.retailHubStoreEdgeSyncReceipts ?? []),
    retailHubStoreEdgeSyncRuns: structuredClone(state.retailHubStoreEdgeSyncRuns ?? []),
    retailHubStoreEdgeSyncPolicy: structuredClone(state.retailHubStoreEdgeSyncPolicy),
    retailHubStoreEdgeSyncCursor: structuredClone(state.retailHubStoreEdgeSyncCursor),
