...
| Products | Yes | Yes | Products / catalog | In progress — the Stock rail opens the compact, evidence-only stock workspace for product/variant availability, SKU, batch, expiry, replenishment and channel-demand review. Catalog writes remain in the accountable product workbench; visual capture, role/error certification and live Hub import remain. |
