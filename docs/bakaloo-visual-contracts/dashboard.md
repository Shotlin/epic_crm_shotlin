...
- **Pinned Bakaloo source:** `src/app/(dashboard)/dashboard/page.tsx`
- **Live recording coverage:** Yes — dashboard (00:04)
- **Reference family:** Dashboard
- **Target Epic destination:** Home / retail command centre
