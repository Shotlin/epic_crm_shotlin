...
- **Pinned Bakaloo source:** `src/app/(dashboard)/customer-activity/page.tsx`
- **Live recording coverage:** No
- **Reference family:** Administrative workspace
- **Target Epic destination:** Mapped in Phase 3 capability audit
