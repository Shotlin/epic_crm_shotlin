# /settings/tip-presets

## Reference evidence

- **Pinned Bakaloo source:** `src/app/(dashboard)/settings/tip-presets/page.tsx`
- **Live recording coverage:** Yes — tip presets (00:24)
- **Reference family:** Settings form
- **Target Epic destination:** Setup / checkout policy
