...
- **Pinned Bakaloo source:** `src/app/(dashboard)/abandoned-carts/page.tsx`
- **Live recording coverage:** Yes — abandoned carts (00:44)
- **Reference family:** Commerce table
- **Target Epic destination:** Customers / cart recovery
- **Required scope:** Store
