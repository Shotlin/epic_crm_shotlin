...
- **Pinned Bakaloo source:** `src/app/(dashboard)/analytics/page.tsx`
- **Live recording coverage:** Yes — analytics (01:04)
- **Reference family:** Analytics
- **Target Epic destination:** Insights / retail analytics
- **Required scope:** HQ + store
