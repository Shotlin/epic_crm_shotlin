# /products/families/:id

## Reference evidence

- **Pinned Bakaloo source:** `src/app/(dashboard)/products/families/[id]/page.tsx`
- **Live recording coverage:** No
- **Reference family:** Master/detail
- **Target Epic destination:** Stock / catalogue
